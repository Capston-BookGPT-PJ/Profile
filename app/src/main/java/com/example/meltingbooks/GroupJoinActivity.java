...
public class GroupJoinActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createGroupButton.setOnClickListener(v -> {
            Intent intent = new Intent(GroupJoinActivity.this, GroupNewCreateActivity.class);
            startActivity(intent);
        });

        searchGroupButton.setOnClickListener(v -> {
            Intent intent = new Intent(GroupJoinActivity.this, SearchActivity.class);
            startActivity(intent);
        });
    }
    ...
    private void setupRecyclerViews() {
        ...
        GroupCardItemAdapter.OnItemClickListener listener = item -> {
            ...
            Intent intent = new Intent(GroupJoinActivity.this, GroupProfileActivity.class);
